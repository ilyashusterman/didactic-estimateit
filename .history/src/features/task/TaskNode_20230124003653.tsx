...
import { DemoButton, WorkspaceWidget } from "./canvas/WorkspaceWidget";
import { CanvasWidget } from "@projectstorm/react-canvas-core";
import { TaskCanvasWidget } from "./canvas/CanvasWidget";

export const TaskDiagram = (props: any) => {
  ...
  return (
    <WorkspaceWidget
      buttons={
        <DemoButton
          onClick={() => {
            JSON.stringify(model.serialize(), null, 2);
          }}
        >
          Serialize Graph
        </DemoButton>
